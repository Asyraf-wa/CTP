...
class PublicationsController extends AppController
{
    ...
    public function index()
    {
        ...
        $this->set('y2021', $this->Publications->find()->where(['year' => '2021'])->count());
        $this->set('y2022', $this->Publications->find()->where(['year' => '2022'])->count());

        $this->set('wos', $this->Publications->find()->where(['pointer' => 'Web of Science'])->count());
        $this->set('scopus', $this->Publications->find()->where(['pointer' => 'Scopus'])->count());
        $this->set('mycite', $this->Publications->find()->where(['pointer' => 'Mycite'])->count());
        $this->set('others', $this->Publications->find()->where(['pointer' => 'Others'])->count());
