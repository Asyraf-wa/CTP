...
class AppController extends Controller
{
		public function beforeFilter(\Cake\Event\EventInterface $event)
	{
		...
		//write to session for global var
		$session = $this->getRequest()->getSession(); 
		$session->write('notification_email', $config->get('notification_email')); 
		$session->write('system_abbr', $config->get('system_abbr')); 
		//$session->delete('global_mail'); //delete specific session
	}
    /**
