...
<meta name="theme-color" content="#ffffff">
	...
	<?php echo $this->Html->css('combine-dark-custom.min.css') ?>
	<?php //echo $this->Html->css('dark.min.css') ?>
	...
	<?php echo $this->Html->script('combine-dark-logo-fade.min.js', ['block' => 'scriptBottom']); ?>
