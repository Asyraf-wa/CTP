...
<div class="row">
	...
	<?php echo $this->Form->control('reference',['label' => 'Reference (APA)', 'required' => false, 'class' =>'tinymce']) ?>
    <script type="text/javascript">
        tinymce.init({
            ...
            menubar: false,
            toolbar1: 'code bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | numlist bullist',
            toolbar_sticky: true,
            height : '200',
            forced_root_block : "", //remove <p> tag
        });
    </script>
