...
<div class="dropdown text-end pt-2 pb-2">
  ...
  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
	...
	<?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $blog->id), 'class' => 'dropdown-item']
            ) ?>
  </ul>
</div>	
<!--Top Menu End-->
...
<?php echo $this->Form->control('publish_on',[
                          ...
                          'value' => date('Y-m-d', strtotime($blog->publish_on)), //for edit page: read the existing data first
                          'empty'=>'empty',
						  'required' => false,
						  'autocomplete' => 'off'
			]); ?>
