...
<body>
    ...
    <div class="card text-center col-md-3 position-absolute top-50 start-50 translate-middle">
        <div class="card bg-body-tertiary border-0 shadow">
            <div class="card-body">
                ...
                <script>
                    ...
                    const lauk = document.querySelector("#lauk");
                    ...
                    const initPixels = () => {
                        ...
                        const colors = Array.from({
                            length: colorsLen
                        }, (_, index) => `hsl(${Math.floor(rand(h, h + (index + 1) * 10))} 100% ${rand(50, 100)}%)`);
                    ...
                    const resize = () => {
                        ...
                        const rect = lauk.getBoundingClientRect();
                    ...
                    new ResizeObserver(resize).observe(lauk);
                ...
                <div class="text-center">
                    <b class="gradient-animate-tiny"><b class="logo-small">&lt;/&gt;</b> <?php echo $system_name; ?></b>
                    <div class="mt-3">
                        ...
                        Copyright &copy; 2022-<SCRIPT LANGUAGE="JavaScript">
                            document.write(y0);
                        </SCRIPT>. All rights reserved. [V <?= $version; ?>]
                    </div>
