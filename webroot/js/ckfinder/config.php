...
//session_name("[php]");
//session_save_path(dirname(dirname(dirname(__FILE__))) . '/tmp/sessions/');
//session_start();
//session_name('CTP');
//session_start();
//use Cake\Http\Session;
//$session = $this->request->getSession();
//echo $session->read('Auth.fullname');
$_SESSION["username"] = "Asyraf";
//print_r($_SESSION);

 if (isset($_SESSION)) {
// this is an example to check if an active user is logged in
	if ($_SESSION != NULL) {
	   return true;
	}
	return false;
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/ctp/webroot/upload', //'/ckfinder/userfiles/',
